      ...
      <div className="sobre_mi">
        <div className="rounded-2xl px-4 mt-1 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 pt-6 m-5">
          <div className="grid gap-9 row-gap-10 lg:grid-cols-2">
            ...
            {/* Imagen */}
            <div className="flex justify-center items-center lg:justify-start lg:mt-0 mt-8">
              <img
                className="object-cover rounded shadow-lg sm:max-w-xs md:max-w-md lg:max-w-full w-full h-auto"
                src={sobremi}
                alt="Sobre mí"
              />
            </div>
