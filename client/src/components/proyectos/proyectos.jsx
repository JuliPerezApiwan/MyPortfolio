export const Proyectos = () => {
    return (
      ...
      <div className="px-4 mx-auto mt-0 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 m-5">
      <h2 className="mb-6 font-sans border-b pb-3 text-white text-3xl text-purple-900 sm:text-4xl sm:leading-none">
             Proyectos
              </h2>
        <div className="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
          <div className=" border-4 border-[#fafb63] rounded-3xl overflow-hidden transition-shadow duration-300  shadow-sm">
            <img
              src="https://res.cloudinary.com/dwwd5fadx/image/upload/v1685074507/Landing_icnfgv.png"
              className="object-cover w-full h-48 mb-4 border-4 border-[#fafb63] rounded-b-full"
              alt=""
            />
            <div className="p-5 border-none">
              <p
                className="inline-block mb-3 text-white text-2xl font-bold leading-5 transition-colors duration-200 hover:text-deep-purple-accent-700 mb-6"
              >
               Dogs
              </p>
          ...
          <div className="border-4 border-[#3fadb5] overflow-hidden transition-shadow duration-300 rounded-3xl shadow-sm">
            <img
              ...
              className="object-cover w-full h-48 mb-4 border-4 border-[#3fadb5] rounded-b-full"
              alt=""
            />
            <div className="p-5 border-none">
              <p
          ...
          <div className="border-4 border-[#fafb63] overflow-hidden transition-shadow duration-300 rounded-3xl shadow-sm">
            <img
              ...
              className="object-cover w-full h-42 mb-4 border-4 border-[#fafb63] rounded-b-full"
              alt=""
            />
            <div className="p-5 border-none">
